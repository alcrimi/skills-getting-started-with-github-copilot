...
activities = {
    ...
    "Science Club": {
        ...
        "max_participants": 22,
        "participants": ["zachary@mergington.edu", "rachel@mergington.edu"]
    }
}
...
def unregister_from_activity(activity_name: str, email: str = Query(..., description="Email of the participant to remove")):
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
    activity = activities[activity_name]
